...
export class OSWAP_MainChainTrollRegistry extends Contract{
    ...
    backerStaking: {
        (params: IBackerStakingParams): Promise<{nft:string,tokenId:BigNumber,trollProfileIndex:BigNumber,timestamp:BigNumber}[]>;
    }
    deny: {
    ...
    getStakeTo: {
        (backer:string): Promise<{nft:string,tokenId:BigNumber,trollProfileIndex:BigNumber,timestamp:BigNumber}[]>;
    }
    getStakedBy: {
        (trollProfileIndex:number|BigNumber): Promise<{nft:string,tokenId:BigNumber}[]>;
    }
    getStakes: {
    ...
    getTrollProperties: {
        (trollProfileIndex:number|BigNumber): Promise<{troll:{owner:string,troll:string,trollType:BigNumber,nftCount:BigNumber},nfts:{nft:string,tokenId:BigNumber}[],backers:string[]}>;
    }
    getTrollPropertiesByAddress: {
        (trollAddress:string): Promise<{troll:{owner:string,troll:string,trollType:BigNumber,nftCount:BigNumber},nfts:{nft:string,tokenId:BigNumber}[],backers:string[]}>;
    }
    getTrolls: {
        (params: IGetTrollsParams): Promise<{owner:string,troll:string,trollType:BigNumber,nftCount:BigNumber}[]>;
    }
    govToken: {
        (): Promise<string>;
    }
    ...
    stakeTo: {
        (params: IStakeToParams): Promise<{nft:string,tokenId:BigNumber,trollProfileIndex:BigNumber,timestamp:BigNumber}>;
    }
    stakeToInv: {
        (params: IStakeToInvParams): Promise<{backer:string,index:BigNumber}>;
    }
    stakeToLength: {
        (backer:string): Promise<BigNumber>;
    }
    stakedBy: {
        (params: IStakedByParams): Promise<{nft:string,tokenId:BigNumber}>;
    }
    stakedByInv: {
        (params: IStakedByInvParams): Promise<{trollProfileIndex:BigNumber,index:BigNumber}>;
    }
    stakedByLength: {
        (trollProfileIndex:number|BigNumber): Promise<BigNumber>;
    }
    ...
    trollProfiles: {
        (param1:number|BigNumber): Promise<{owner:string,troll:string,trollType:BigNumber,nftCount:BigNumber}>;
    }
    trollProfilesLength: {
        (): Promise<BigNumber>;
    }
    ...
    private assign(){
        ...
        let backerStaking_call = async (params: IBackerStakingParams): Promise<{nft:string,tokenId:BigNumber,trollProfileIndex:BigNumber,timestamp:BigNumber}[]> => {
        ...
        let getStakeTo_call = async (backer:string): Promise<{nft:string,tokenId:BigNumber,trollProfileIndex:BigNumber,timestamp:BigNumber}[]> => {
        ...
        let getStakedBy_call = async (trollProfileIndex:number|BigNumber): Promise<{nft:string,tokenId:BigNumber}[]> => {
        ...
        let getStakes_call = async (troll:string): Promise<BigNumber> => {
            let result = await this.call('getStakes',[troll]);
            return new BigNumber(result);
        }
        this.getStakes = getStakes_call
        let getStakesByTrollProfile_call = async (trollProfileIndex:number|BigNumber): Promise<BigNumber> => {
        ...
        let getTrollByNft_call = async (params: IGetTrollByNftParams): Promise<string> => {
            let result = await this.call('getTrollByNft',getTrollByNftParams(params));
            return result;
        }
        this.getTrollByNft = getTrollByNft_call
        let getTrollProperties_call = async (trollProfileIndex:number|BigNumber): Promise<{troll:{owner:string,troll:string,trollType:BigNumber,nftCount:BigNumber},nfts:{nft:string,tokenId:BigNumber}[],backers:string[]}> => {
        ...
        let getTrollPropertiesByAddress_call = async (trollAddress:string): Promise<{troll:{owner:string,troll:string,trollType:BigNumber,nftCount:BigNumber},nfts:{nft:string,tokenId:BigNumber}[],backers:string[]}> => {
        ...
        let getTrolls_call = async (params: IGetTrollsParams): Promise<{owner:string,troll:string,trollType:BigNumber,nftCount:BigNumber}[]> => {
        ...
        let nftType_call = async (param1:string): Promise<BigNumber> => {
        ...
        let ownerTrolls_call = async (params: IOwnerTrollsParams): Promise<BigNumber> => {
            let result = await this.call('ownerTrolls',ownerTrollsParams(params));
            return new BigNumber(result);
        }
        this.ownerTrolls = ownerTrolls_call
        let ownerTrollsLength_call = async (owner:string): Promise<BigNumber> => {
        ...
        let stakeTo_call = async (params: IStakeToParams): Promise<{nft:string,tokenId:BigNumber,trollProfileIndex:BigNumber,timestamp:BigNumber}> => {
        ...
        let stakeToInv_call = async (params: IStakeToInvParams): Promise<{backer:string,index:BigNumber}> => {
        ...
        let stakeToLength_call = async (backer:string): Promise<BigNumber> => {
        ...
        let stakedBy_call = async (params: IStakedByParams): Promise<{nft:string,tokenId:BigNumber}> => {
        ...
        let stakedByInv_call = async (params: IStakedByInvParams): Promise<{trollProfileIndex:BigNumber,index:BigNumber}> => {
        ...
        let trollProfiles_call = async (param1:number|BigNumber): Promise<{owner:string,troll:string,trollType:BigNumber,nftCount:BigNumber}> => {
        ...
        let trollProfilesLength_call = async (): Promise<BigNumber> => {
        ...
        let addStakesGeneralTroll_send = async (params: IAddStakesGeneralTrollParams): Promise<TransactionReceipt> => {
            let result = await this.send('addStakesGeneralTroll',addStakesGeneralTrollParams(params));
            return result;
        }
        let addStakesGeneralTroll_call = async (params: IAddStakesGeneralTrollParams): Promise<void> => {
        ...
        let addStakesSuperTroll_send = async (params: IAddStakesSuperTrollParams): Promise<TransactionReceipt> => {
            let result = await this.send('addStakesSuperTroll',addStakesSuperTrollParams(params));
            return result;
        }
        let addStakesSuperTroll_call = async (params: IAddStakesSuperTrollParams): Promise<void> => {
        ...
        let initAddress_send = async (votingManager:string): Promise<TransactionReceipt> => {
            let result = await this.send('initAddress',[votingManager]);
            return result;
        }
        let initAddress_call = async (votingManager:string): Promise<void> => {
        ...
        let onERC721Received_send = async (params: IOnERC721ReceivedParams): Promise<TransactionReceipt> => {
            let result = await this.send('onERC721Received',onERC721ReceivedParams(params));
            return result;
        }
        let onERC721Received_call = async (params: IOnERC721ReceivedParams): Promise<string> => {
        ...
        let stakeGeneralTroll_send = async (params: IStakeGeneralTrollParams): Promise<TransactionReceipt> => {
            let result = await this.send('stakeGeneralTroll',stakeGeneralTrollParams(params));
            return result;
        }
        let stakeGeneralTroll_call = async (params: IStakeGeneralTrollParams): Promise<void> => {
        ...
        let stakeSuperTroll_send = async (params: IStakeSuperTrollParams): Promise<TransactionReceipt> => {
            let result = await this.send('stakeSuperTroll',stakeSuperTrollParams(params));
            return result;
        }
        let stakeSuperTroll_call = async (params: IStakeSuperTrollParams): Promise<void> => {
        ...
        let unstakeGeneralTroll_send = async (params: IUnstakeGeneralTrollParams): Promise<TransactionReceipt> => {
            let result = await this.send('unstakeGeneralTroll',unstakeGeneralTrollParams(params));
            return result;
        }
        let unstakeGeneralTroll_call = async (params: IUnstakeGeneralTrollParams): Promise<BigNumber> => {
        ...
        let unstakeSuperTroll_send = async (params: IUnstakeSuperTrollParams): Promise<TransactionReceipt> => {
            let result = await this.send('unstakeSuperTroll',unstakeSuperTrollParams(params));
            return result;
        }
        let unstakeSuperTroll_call = async (params: IUnstakeSuperTrollParams): Promise<BigNumber> => {
        ...
        let updateNft_send = async (params: IUpdateNftParams): Promise<TransactionReceipt> => {
            let result = await this.send('updateNft',updateNftParams(params));
            return result;
        }
        let updateNft_call = async (params: IUpdateNftParams): Promise<void> => {
        ...
        let updateVotingManager_send = async (): Promise<TransactionReceipt> => {
            let result = await this.send('updateVotingManager');
            return result;
        }
        let updateVotingManager_call = async (): Promise<void> => {
...
export module OSWAP_MainChainTrollRegistry{
    ...
    export interface StakeGeneralTollEvent {backer:string,trollProfileIndex:BigNumber,nft:string,tokenId:BigNumber,stakesChange:BigNumber,stakesBalance:BigNumber,_event:Event}
    export interface StakeSuperTollEvent {backer:string,trollProfileIndex:BigNumber,nft:string,tokenId:BigNumber,stakesChange:BigNumber,stakesBalance:BigNumber,_event:Event}
    export interface StartOwnershipTransferEvent {user:string,_event:Event}
    export interface TransferOwnershipEvent {user:string,_event:Event}
    export interface UnstakeGeneralTollEvent {backer:string,trollProfileIndex:BigNumber,nft:string,tokenId:BigNumber,stakesChange:BigNumber,stakesBalance:BigNumber,_event:Event}
    export interface UnstakeSuperTollEvent {backer:string,trollProfileIndex:BigNumber,nft:string,tokenId:BigNumber,stakesChange:BigNumber,stakesBalance:BigNumber,_event:Event}
